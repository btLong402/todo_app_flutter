...
enum InputType { email, password , confirm}
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: widget.type != null
                ...
                : null,
            suffix: (widget.type != null && (widget.type == InputType.password || widget.type == InputType.confirm))
                ? GestureDetector(
                    onTap: () {
                      setState(() {
                        hidden = !hidden;
          ...
          obscureText: hidden && (widget.type == InputType.password || widget.type == InputType.confirm),
        )
      ],
    );
  }
